...
// --- Helper Components (Đã sửa ListItem) ---
...
// **ListItem**: Sửa lại cách render children để tương thích tốt hơn với prose
const ListItem = ({ title, children, className = "" }) => (
  <motion.li variants={contentChildVariants} className={`mb-3 ${className}`}>
    {/* Strong tag sẽ được prose style */}
    {title && <strong className="text-lg block mb-1">{title}</strong>}
    {/*
      Render children trực tiếp bên trong div.
      Prose sẽ tự động style thẻ p (mặc định) hoặc các thẻ khác bên trong.
      Thêm mt-1 để có khoảng cách nhỏ với title nếu có.
    */}
    {children && (
...
// **SlideTitle**: Giữ nguyên
const SlideTitle = ({ children }) => (
  <motion.h2 variants={contentChildVariants} className="text-3xl md:text-4xl font-bold mb-6 pb-2 border-b-2 border-blue-500/30 text-blue-600 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-blue-400 dark:to-purple-500">
    {children}
  </motion.h2>
);
...
export const slidesContent = [
  // --- Slide 1: Tiêu đề ---
  {
    ...
    content: (
      <motion.div variants={contentChildVariants} className="flex flex-col items-center justify-center h-full text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-500 leading-tight break-words">
  ...
  // --- Slide 2: Độc quyền là gì? ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐỘC QUYỀN LÀ GÌ?</SlideTitle>
 ...
 // --- Slide 3: Nguyên nhân hình thành ĐQ ---
  {
    ...
    content: (
      <>
        <SlideTitle>NGUYÊN NHÂN HÌNH THÀNH ĐỘC QUYỀN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 4: Giá cả & Lợi nhuận ĐQ ---
  {
    ...
    content: (
      <>
        <SlideTitle>GIÁ CẢ & LỢI NHUẬN ĐỘC QUYỀN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 5: Độc quyền nhà nước (ĐQNN) ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐỘC QUYỀN NHÀ NƯỚC (ĐQNN)</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
          <ListItem title="Khái niệm">
  ...
  // --- Slide 6: Nguyên nhân hình thành ĐQNN ---
  {
    ...
    content: (
      <>
        <SlideTitle>NGUYÊN NHÂN HÌNH THÀNH ĐQNN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 7: Tác động tích cực của ĐQ ---
  {
    ...
    content: (
      <>
        <SlideTitle>TÁC ĐỘNG TÍCH CỰC CỦA ĐỘC QUYỀN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 8: Tác động tiêu cực của ĐQ ---
  {
    ...
    content: (
      <>
        <SlideTitle>TÁC ĐỘNG TIÊU CỰC CỦA ĐỘC QUYỀN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 9: Cạnh tranh trong trạng thái ĐQ ---
  {
    ...
    content: (
      <>
        <SlideTitle>CẠNH TRANH TRONG TRẠNG THÁI ĐQ</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
          <ListItem>
  ...
  // --- Slide 10: Kết luận (Phần 1) ---
  {
    ...
    content: (
      <>
        <SlideTitle>KẾT LUẬN (PHẦN 4.1)</SlideTitle>
  ...
  // --- Slide 11: 5 Đặc điểm của ĐQ (Lênin) ---
  {
    ...
    content: (
      <>
        <SlideTitle>5 ĐẶC ĐIỂM KINH TẾ CỦA ĐQ (LÊNIN)</SlideTitle>
  ...
  // --- Slide 12: Đặc điểm 1: Tích tụ & Tập trung ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐĐ 1: TÍCH TỤ & TẬP TRUNG TƯ BẢN LỚN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 13: Đặc điểm 2: Tư bản tài chính & Tài phiệt ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐĐ 2: TƯ BẢN TÀI CHÍNH VÀ TÀI PHIỆT</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 14: Đặc điểm 3: Xuất khẩu tư bản (XKTB) ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐĐ 3: XUẤT KHẨU TƯ BẢN (XKTB)</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
          <ListItem title="Khái niệm">
            Là xuất khẩu giá trị (đầu tư) ra nước ngoài nhằm thu giá trị thặng
            dư.
          </ListItem>
  ...
  // --- Slide 15: Đặc điểm 4 & 5: Phân chia thế giới ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐĐ 4 & 5: PHÂN CHIA THẾ GIỚI</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 16: Đặc trưng của ĐQNN ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐẶC TRƯNG KINH TẾ CỦA ĐQNN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-3 list-decimal list-outside pl-8">
  ...
  // --- Slide 17: ĐQNN - Đặc trưng 1: Kết hợp nhân sự ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐQNN (1): SỰ KẾT HỢP VỀ NHÂN SỰ</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 18: ĐQNN - Đặc trưng 2: Sở hữu nhà nước ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐQNN (2): SỞ HỮU NHÀ NƯỚC</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 19: ĐQNN - Đặc trưng 3: Điều tiết kinh tế ---
  {
    ...
    content: (
      <>
        <SlideTitle>ĐQNN (3): NHÀ NƯỚC ĐIỀU TIẾT KINH TẾ</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 20: BHM 1: Tích tụ & Tập trung ---
  {
    ...
    content: (
      <>
        <SlideTitle>BHM 1: TÍCH TỤ & TẬP TRUNG TƯ BẢN</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
          <ListItem title="Hình thức tổ chức mới (Công ty xuyên quốc gia)">
            <ul>
              ...
              <SubItem>
                ...
                <strong>không liên quan</strong>. (Mục đích: thu lợi từ chứng
                khoán).
              </SubItem>
            </ul>
          </ListItem>
  ...
  // --- Slide 21: BHM 2: Tư bản tài chính ---
  {
    ...
    content: (
      <>
        <SlideTitle>BHM 2: VAI TRÒ CỦA TƯ BẢN TÀI CHÍNH</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
  ...
  // --- Slide 22: BHM 3: Xuất khẩu tư bản (XKTB) ---
  {
    ...
    content: (
      <>
        <SlideTitle>BHM 3: XUẤT KHẨU TƯ BẢN (XKTB)</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-3 list-decimal list-outside pl-8 text-xl">
          <ListItem>
             Thay đổi về hướng: Dòng vốn chảy
             qua lại giữa các nước phát triển.
          </ListItem>
          <ListItem>
             Thay đổi về chủ thể: Vai trò của
             Công ty xuyên quốc gia (TNCs) tăng.
          </ListItem>
          <ListItem>
             Thay đổi về hình thức: Xuất hiện
             BOT, BT...
          </ListItem>
          <ListItem>
             Thay đổi về nguyên tắc: Nguyên tắc
  ...
  // --- Slide 23: BHM 4 & 5: Phân chia thị trường & Lãnh thổ ---
  {
    ...
    content: (
      <>
        <SlideTitle>BHM 4 & 5: PHÂN CHIA THỊ TRƯỜNG & LÃNH THỔ</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
          ...
          <ListItem title="Phân chia lãnh thổ (Ảnh hưởng)">
            <ul>
              <SubItem>
                Hình thức mới: "Chiến lược biên giới mềm", bành
                trướng "biên giới kinh tế".
              </SubItem>
              <SubItem>
                Thay thế chiến tranh thế giới bằng
                chiến tranh thương mại, sắc tộc...
              </SubItem>
            </ul>
          </ListItem>
        </motion.ul>
  ...
  // --- Slide 24: BHM của ĐQNN (P.1) ---
  {
    ...
    content: (
      <>
        <SlideTitle>BHM CỦA ĐQNN (P.1)</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
          ...
          <ListItem title="2. Về sở hữu nhà nước (Vai trò Nhà nước)">
            <ul>
              <SubItem>
                Nhà nước tăng đầu tư vào R&D, kết cấu hạ tầng (gánh chịu rủi
                ro).
              </SubItem>
              <SubItem>
              ...
              <SubItem>
                ...
                đ đoàn lớn (VD: Citigroup, AIG 2008).
              </SubItem>
            </ul>
          </ListItem>
        </motion.ul>
  ...
  // --- Slide 25: BHM của ĐQNN (P.2) ---
  {
    ...
    content: (
      <>
        <SlideTitle>BHM CỦA ĐQNN (P.2)</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4">
          <ListItem title="3. Về vai trò điều tiết kinh tế">
            <ul>
              <SubItem>
                <strong>Điều tiết chính trị:</strong> Dùng "Đa nguyên tư sản" để
                làm dịu đấu tranh.
              </SubItem>
              <SubItem>
  ...
  // --- SLIDE 26: LIÊN HỆ ---
  {
    ...
    content: (
      <>
        <SlideTitle>LIÊN HỆ: ÂN XÁ TÀI PHIỆT HÀN QUỐC 2022</SlideTitle>
        {/* Sửa màu chữ/nền cho light mode */}
        ...
        <motion.ul variants={contentChildVariants} className="space-y-4">
          <ListItem title="Tầm quan trọng kinh tế của Chaebol">
            <ul>
              <SubItem>
   ...
   // --- SLIDE 27: REFERENCES ---
  {
    ...
    content: (
      <>
        <SlideTitle>TÀI LIỆU THAM KHẢO</SlideTitle>
        <motion.ul variants={contentChildVariants} className="space-y-4 list-disc list-outside pl-6">
          ...
          {/* Thêm các tài liệu khác nếu cần */}
        </motion.ul>
      </>
    ),
  },
